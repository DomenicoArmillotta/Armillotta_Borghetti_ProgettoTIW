...
CREATE TABLE `asta_aperta` (
  ...
  `id_utente` varchar(45) NOT NULL DEFAULT '999',
...
CREATE TABLE `asta_chiusa` (
  ...
  PRIMARY KEY (`asta_id`),
  KEY `utente2_idx` (`id_utente`),
  CONSTRAINT `utente2` FOREIGN KEY (`id_utente`) REFERENCES `utente` (`id_utente`)
...
CREATE TABLE `dettaglio_asta` (
  ...
  PRIMARY KEY (`data_offerta`,`offerente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `utente` VALUES ('1','1234','via tali '),('2','1234','via tali '),('3','1234','via tali '),('4','1234','via tali ');
...
-- Dump completed on 2021-04-08 14:56:58
