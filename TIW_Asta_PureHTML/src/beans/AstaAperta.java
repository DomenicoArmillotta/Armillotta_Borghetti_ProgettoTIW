...
public class AstaAperta extends Asta{
	...
	public AstaAperta(int asta_id, String descrizione, String immagine, Date scadenza, float minimo_rialzo,float prezzo_iniziale,Date data_apertura ,String id_utente,String titolo,float max_offerta) {
		super(asta_id, descrizione, immagine , scadenza , id_utente,titolo,data_apertura);
